        ...
        >
          ...
          <div className="w-full p-2 gap-3 flex flex-row overflow-x-scroll md:overflow-auto md:grid md:grid-cols-6">
            <img
              ...
              tabindex="1"
              alt="pip white"
              src="https://i.ibb.co/vdtWz25/pip-white.png"
            ...
            <img
              ...
              tabindex="1"
              alt="pip brown"
              src="https://i.ibb.co/r7CVLR2/pip-brown.png"
              onClick={handleImageClick}
            />
            ...
            <img
              ...
              tabindex="1"
              alt="pip purple"
              src="https://i.ibb.co/NCHspTx/pip-purple.png"
              onClick={handleImageClick}
            />
            <img
              className={`bg-gray-500 mt-4 rounded-full w-44 h-44 md:w-32 md:h-32 focus:outline-none focus:ring focus:ring-violet-300`}
              tabindex="1"
              alt="pip wbrown"
              src="https://i.ibb.co/q5cHPj6/pip-wbrown.png"
              onClick={handleImageClick}
            />
            <img
              className={`bg-gray-500 mt-4 rounded-full w-44 h-44 md:w-32 md:h-32 focus:outline-none focus:ring focus:ring-violet-300`}
              tabindex="1"
              alt="pip green"
              src="https://i.ibb.co/wsMP8G6/pip-green.png"
              onClick={handleImageClick}
            />
            <img
              className={`bg-gray-500 mt-4 rounded-full w-44 h-44 md:w-32 md:h-32 focus:outline-none focus:ring focus:ring-violet-300`}
              tabindex="1"
              alt="pip blue"
              src="https://i.ibb.co/pwFRHRb/pip-blue.png"
              onClick={handleImageClick}
            />
            <img
              className={`bg-gray-500 mt-4 rounded-full w-44 h-44 md:w-32 md:h-32 focus:outline-none focus:ring focus:ring-violet-300`}
              tabindex="1"
              alt="pip yellow"
              src="https://i.ibb.co/HzfCLs8/pip-yellow.png"
              onClick={handleImageClick}
            />
            <img
              className={`bg-gray-500 mt-4 rounded-full w-44 h-44 md:w-32 md:h-32 focus:outline-none focus:ring focus:ring-violet-300`}
              tabindex="1"
              alt="pip pink"
              src="https://i.ibb.co/84TgqfC/pip-pink.png"
              onClick={handleImageClick}
            />
          </div>
